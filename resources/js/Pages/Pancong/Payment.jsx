...
export default function Payment() {
    ...
    console.log('ini data keranjang', keranjang)
    return (
                        ...
                        <Card key={i}>
                            <CardHeader className="flex flex-row">
                                ...
                                <div className="flex flex-col justify-center gap-2 ml-4">
                                    ...
                                    <CardDescription>Rp. {item.harga.toLocaleString('id')}</CardDescription>
                                    <CardDescription>Jumlah beli {item.jumlah}</CardDescription>
                                </div>
                            </CardHeader>
                        </Card>
                    ))}
